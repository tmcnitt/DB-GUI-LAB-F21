...
export const SearchBar = props => {
    ...
    return <div class="w-75 mx-auto">
        <Form id="search-articles">
            <Row>
                <Form.Group className="mb-2 col-md-6" controlId="title">
                    <Form.Control type="text" maxLength="255" placeholder="Enter Title" value={title} onChange={(e) => setTitle(e.target.value)} />
                </Form.Group>
                <Form.Group className="mb-2 col-md-6" controlId="authorLastName">
        ...
        <button class="btn btn-success col-md-12" onClick={() => props.onSearch({ title, authorLastName })} form="search-form">Search</button>
    </div>
